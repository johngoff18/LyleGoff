...
class WebAppsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create web_app" do
    assert_difference('WebApp.count') do
      post web_apps_url, params: { web_app: { description: @web_app.description, image_url: @web_app.image_url, link: @web_app.link, name: @web_app.name } }
    end
  ...
  test "should update web_app" do
    patch web_app_url(@web_app), params: { web_app: { description: @web_app.description, image_url: @web_app.image_url, link: @web_app.link, name: @web_app.name } }
